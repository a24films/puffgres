...
mod tests {
    ...
    #[test]
    fn id_compat_uint_int4() {
        assert!(check_id_type_compat(&IdType::Uint, "int4").is_none());
    }

    #[test]
    fn id_compat_uint_int8() {
        assert!(check_id_type_compat(&IdType::Uint, "int8").is_none());
    }

    #[test]
    fn id_compat_int_int4() {
        assert!(check_id_type_compat(&IdType::Int, "int4").is_none());
    }

    #[test]
    fn id_compat_uuid() {
        assert!(check_id_type_compat(&IdType::Uuid, "uuid").is_none());
    }

    #[test]
    fn id_compat_string_text() {
        assert!(check_id_type_compat(&IdType::String, "text").is_none());
    }

    #[test]
    fn id_compat_string_varchar() {
        assert!(check_id_type_compat(&IdType::String, "varchar").is_none());
    }

    #[test]
    fn id_incompat_uint_uuid() {
        assert!(check_id_type_compat(&IdType::Uint, "uuid").is_some());
    }

    #[test]
    fn id_incompat_uuid_text() {
        assert!(check_id_type_compat(&IdType::Uuid, "text").is_some());
    }

    #[test]
    fn id_incompat_uint_text() {
        assert!(check_id_type_compat(&IdType::Uint, "text").is_some());
    }
}
