// Transform for {{NAME}} (Together AI embeddings)
//
...
for await (const line of rl) {
  ...
  // See https://docs.together.ai/docs/embeddings-overview for available models
  const vectors = textsToEmbed.length > 0
    ? await embedBatch(textsToEmbed, "togethercomputer/m2-bert-80M-8k-retrieval")
    : [];
